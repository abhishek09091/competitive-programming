...
class Intersect
{
    ...
    public static int getIntersection(int d,Node head1,Node head2){
	...
	int intersectPoint(Node headA, Node headB){
         ...
         if(count1 > count2){
             return getIntersection(count1-count2,headA,headB);
         }else{
             return getIntersection(count2-count1,headB,headA);
         }
	}
}
